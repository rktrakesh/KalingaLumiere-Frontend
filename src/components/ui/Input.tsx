  ...
  return (
    <div className="space-y-1.5">
      ...
      <div className="relative">
        ...
        <input ref={ref} id={inputId} className={cn('w-full min-h-10 rounded-md border bg-white dark:bg-gray-900 text-sm text-gray-900 dark:text-white placeholder-gray-400 shadow-sm transition-all focus:outline-none focus:ring-1 focus:ring-brand-500 focus:border-brand-500', error ? 'border-red-500' : 'border-gray-300 dark:border-gray-600', leftIcon ? 'pl-10' : 'pl-3.5', rightIcon ? 'pr-10' : 'pr-3.5', 'py-2.5', className)} {...props} />
